...
export interface BannerOptions {
  colored?: boolean;
  subtitle?: string;
  /** When true, loop the animation forever (discord mode keeps the process alive). */
  loop?: boolean;
}
 ...
 */
export function playRobotBanner(opts: BannerOptions = {}): void {
  const { colored = false, subtitle, loop = false } = opts;
