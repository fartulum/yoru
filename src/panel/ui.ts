...
<header>
  <div class="logo">🌙</div>
  <div><h1>yoru owner panel</h1><div class="sub">commands, economy, verification, servers</div></div>
...
<section id="commands">
  <div class="card"><h2>Command overrides</h2>
    <p class="muted">Toggle any command on/off. Changes apply instantly to the running bot.</p>
